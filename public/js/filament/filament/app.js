(() => {
      ...
      (function (i, a, w) {
        ...
        function X() {
          if (!A) {
            A = {};
            for (var e in c)
              (e > 95 && e < 112) || (c.hasOwnProperty(e) && (A[c[e]] = e));
          }
          return A;
        }
        function Y(e, r, s) {
        ...
        function G(e, r) {
          ...
          for (s = Q(e), k = 0; k < s.length; ++k)
            ((h = s[k]),
              ...
              E(h) && M.push(h));
          return ((r = Y(h, M, r)), { key: h, modifiers: M, action: r });
        }
        function R(e, r) {
        ...
        function g(e) {
            ...
            for (
              ...
              if (
                ...
                !(!l && _.seq && s[_.seq] != _.level) &&
                  O == _.action &&
                  ((O == 'keypress' && !p.metaKey && !p.ctrlKey) ||
                    F(f, _.modifiers)))
              ) {
                var ee = !l && _.combo == d,
                  te = l && _.seq == l && _.level == b;
                ((ee || te) && r._callbacks[o].splice(u, 1), C.push(_));
              }
            return C;
          }
          function N(o, f, p, l) {
          ...
          function $(o, f, p, l) {
            ...
            function b(O) {
              (N(p, O, o), l !== 'keyup' && (k = U(O)), setTimeout(L, 10));
            }
          ...
          function z(o, f, p, l, d) {
            ((r._directMap[o + ':' + p] = f), (o = o.replace(/\s+/g, ' ')));
            var b = o.split(' '),
              u;
            if (b.length > 1) {
              $(o, b, f, p);
        ...
        ((g.prototype.bind = function (e, r, s) {
          ...
          (g.prototype.trigger = function (e, r) {
            var s = this;
            return (
              s._directMap[e + ':' + r] && s._directMap[e + ':' + r]({}, e),
              s
            );
          }),
  ...
  document.addEventListener('livewire:init', () => {
    Livewire.interceptRequest(({ request: t, onError: n, onFailure: i }) => {
      (n(({ response: a, preventDefault: w }) => {
        ...
        try {
          ...
          if (S && JSON.parse(S).components.length === 1) {
            for (let A of JSON.parse(S).components)
