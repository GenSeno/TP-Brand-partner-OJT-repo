<template>
    ...
    <div
        class="sidebar-themesettings offcanvas offcanvas-end"
        id="theme-setting"
    >
        <div
            ...
            >
                <div class="accordion-item border px-3 layout-select">
                    <h2 class="accordion-header">
                        <button
                            class="accordion-button text-dark bg-transparent fs-16 px-0 py-3"
                            type="button"
                    ...
                    >
                        <div class="accordion-body border-top px-0 py-3">
                            <div class="row gx-3">
                                <div class="col-4">
                                    <div class="theme-layout mb-3">
                                        ...
                                        <label for="defaultLayout">
                                            <span
                                                class="d-block mb-2 layout-img"
                                            >
                                                <img
                                                    src="/img/theme/default.svg"
                                                    alt="img"
                                                />
                                            </span>
                                ...
                                <div class="col-4">
                                    <Link
                                        href="/layouts/layout-rtl"
                                        class="theme-layout mb-3"
                                    >
                                        <span class="d-block mb-2 layout-img">
                                            <img
                                                src="/img/theme/rtl.svg"
                                                alt="img"
                                            />
                                        </span>
                                        <span class="layout-type d-block"
                                            >RTL</span
                                        >
                                    </Link>
                                </div>
                ...
                <div class="accordion-item border px-3 layout-select">
                    <h2 class="accordion-header">
                        <button
                            class="accordion-button text-dark fs-16 bg-transparent px-0 py-3"
                            type="button"
                            data-bs-toggle="collapse"
                        ...
                        <div class="accordion-body px-0 py-3 border-top">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="theme-width m-1">
                                    ...
                                    >
                                        <i
                                            class="ti ti-layout-distribute-horizontal me-1"
                                        ></i>
                                        Boxed Layout
                                    </label>
                                </div>
                ...
                <div class="accordion-item border px-3">
                    <h2 class="accordion-header">
                        <button
                            class="accordion-button text-dark fs-16 px-0 py-3 bg-transparent"
                            type="button"
                            data-bs-toggle="collapse"
                    ...
                    >
                        <div class="accordion-body pb-1 px-0 py-3 border-top">
                            ...
                            <div class="d-flex align-items-center flex-wrap">
                                <div
                                    class="theme-colorselect theme-colorselect-rounded mb-3 me-3"
                                >
                                    <input
                                        type="radio"
                                        name="topbar"
                                ...
                                >
                                    <input
                                        ...
                                        name="topbar"
                                        id="darkaquaTopbar"
                                        value="topbarcolorone"
                                    />
                                    <label
                                        for="darkaquaTopbar"
                                        class="bg-sidebar-color-1"
                                    ></label>
                                </div>
                                <div
                                    class="theme-colorselect theme-colorselect-rounded mb-3 me-3"
                                >
                                    <input
                                        ...
                                        name="topbar"
                                        id="whiterockTopbar"
                                        value="topbarcolortwo"
                                    />
                                    <label
                                        for="whiterockTopbar"
                                        class="bg-sidebar-color-2"
                                    ></label>
                                </div>
                                <div
                                    class="theme-colorselect theme-colorselect-rounded mb-3 me-3"
                                >
                                    <input
                                        ...
                                        name="topbar"
                                        id="rockblueTopbar"
                                        value="topbarcolorthree"
                                    />
                                    <label
                                        for="rockblueTopbar"
                                        class="bg-sidebar-color-3"
                                    ></label>
                                </div>
                                <div
                                    class="theme-colorselect theme-colorselect-rounded mb-3 me-3"
                                >
                                    <input
                                        ...
                                        name="topbar"
                                        id="bluehazeTopbar"
                                        value="topbarcolorfour"
                                    />
                                    <label
                                        for="bluehazeTopbar"
                                        class="bg-sidebar-color-4"
                                    ></label>
                                </div>
                                <div
                                    class="theme-colorselect theme-colorselect-rounded mb-3 me-3"
                                >
                                    <input
                                        ...
                                        name="topbar"
                                        id="topbar-color-5"
                                        value="topbarcolorfive"
                                    />
                                    <label
                                        for="topbar-color-5"
                                        class="bg-sidebar-color-5"
                                    ></label>
                                </div>
                                <div
                                    class="theme-colorselect theme-colorselect-rounded mb-3 me-3"
                                >
                                    <input
                                        ...
                                        name="topbar"
                                        id="topbar-color-6"
                                        value="topbarcolorsix"
                                    />
                                    <label
                                        for="topbar-color-6"
                                        class="bg-sidebar-color-6"
                                    ></label>
                                </div>
                                <div
                                    class="theme-colorselect theme-colorselect-rounded mb-3 mt-0"
                                >
                            ...
                            <div class="d-flex align-items-center flex-wrap">
                                ...
                                >
                                    <input
                                        ...
                                        name="topbar"
                                        id="topbar-color-7"
                                        value="topbarcolorseven"
                                    />
                                    <label
                                        for="topbar-color-7"
                                        class="bg-sidebar-color-7"
                                    ></label>
                                </div>
                                <div
                                    class="theme-colorselect theme-colorselect-rounded mb-3 me-3"
                                >
                                    <input
                                        ...
                                        name="topbar"
                                        id="topbar-color-8"
                                        value="topbarcoloreight"
                                    />
                                    <label
                                        for="topbar-color-8"
                                        class="bg-sidebar-color-8"
                                    ></label>
                                </div>
                                <div
                                    class="theme-colorselect theme-colorselect-rounded mb-3 me-3"
                                >
                                    <input
                                        ...
                                        name="topbar"
                                        id="topbar-color-9"
                                        value="topbarcolornine"
                                    />
                                    <label
                                        for="topbar-color-9"
                                        class="bg-sidebar-color-9"
                                    ></label>
                                </div>
                                <div
                                    class="theme-colorselect theme-colorselect-rounded mb-3 me-3"
                                >
                                    <input
                                        ...
                                        name="topbar"
                                        id="topbar-color-10"
                                        value="topbarcolorten"
                                    />
                                    <label
                                        for="topbar-color-10"
                                        class="bg-sidebar-color-10"
                                    ></label>
                                </div>
                                <div
                                    class="theme-colorselect theme-colorselect-rounded mb-3 me-3"
                                >
                                    <input
                                        ...
                                        name="topbar"
                                        id="topbar-color-11"
                                        value="topbarcoloreleven"
                                    />
                                    <label
                                        for="topbar-color-11"
                                        class="bg-sidebar-color-11"
                                    ></label>
                                </div>
                                <div
                                    class="theme-colorselect theme-colorselect-rounded mb-3 me-3"
                                >
                                    <input
                                        ...
                                        name="topbar"
                                        id="topbar-color-12"
                                        value="topbarcolortwelve"
                                    />
                                    <label
                                        for="topbar-color-12"
                                        class="bg-sidebar-color-12"
                                    ></label>
                                </div>
                                <div
                                    class="theme-colorselect theme-colorselect-rounded mb-3 me-3"
                                >
                                    <input
                                        ...
                                        name="topbar"
                                        id="topbar-color-13"
                                        value="topbarcolorthirteen"
                                    />
                                    <label
                                        for="topbar-color-13"
                                        class="bg-sidebar-color-13"
                                    ></label>
                                </div>
                                <div
                                    class="theme-colorselect theme-colorselect-rounded mb-3 me-3"
                                >
                                    <input
                                        ...
                                        name="topbar"
                                        id="topbar-color-14"
                                        value="topbarcolorfourteen"
                                    />
                                    <label
                                        for="topbar-color-14"
                                        class="bg-sidebar-color-14"
                                    ></label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="theme-colorselect me-3">
                                    <input
                                        ...
                                        name="sidebar"
                                        id="bgcolorSidebar"
                                        value="sidebarcolorone"
                                    />
                                    <label
                                        for="bgcolorSidebar"
                                        class="d-block bg-sidebar-color-1 mb-2"
                                    >
                                    </label>
                                </div>
                                <div class="theme-colorselect me-3">
                                    <input
                                        ...
                                        name="sidebar"
                                        id="bgcolor2Sidebar"
                                        value="sidebarcolortwo"
                                    />
                                    <label
                                        for="bgcolor2Sidebar"
                                        class="d-block bg-sidebar-color-2 mb-2"
                                    >
                                    </label>
                                </div>
                                <div class="theme-colorselect me-3">
                                    <input
                                        ...
                                        name="sidebar"
                                        id="bgcolor3Sidebar"
                                        value="sidebarcolorthree"
                                    />
                                    <label
                                        for="bgcolor3Sidebar"
                                        class="d-block bg-sidebar-color-3 mb-2"
                                    >
                                    </label>
                                </div>
                                <div class="theme-colorselect me-3">
                                    <input
                                        ...
                                        name="sidebar"
                                        id="bgcolor4Sidebar"
                                        value="sidebarcolorfour"
                                    />
                                    <label
                                        for="bgcolor4Sidebar"
                                        class="d-block bg-sidebar-color-4 mb-2"
                                    >
                                    </label>
                                </div>
                                <div class="theme-colorselect me-3">
                                    <input
                                        ...
                                        name="sidebar"
                                        id="bgcolor5Sidebar"
                                        value="sidebarcolorfive"
                                    />
                                    <label
                                        for="bgcolor5Sidebar"
                                        class="d-block bg-sidebar-color-5 mb-2"
                                    >
                                    </label>
                                </div>
                                <div class="theme-colorselect me-3">
                                    <input
                                        ...
                                        name="sidebar"
                                        id="bgcolor6Sidebar"
                                        value="sidebarcolorsix"
                                    />
                                    <label
                                        for="bgcolor6Sidebar"
                                        class="d-block bg-sidebar-color-6 mb-2"
                                    >
                                    </label>
                                </div>
                            ...
                            <div class="d-flex align-items-center">
                                <div class="theme-colorselect m-1 me-3">
                                    <input
                                        ...
                                        name="sidebar"
                                        id="bgcolor7Sidebar"
                                        value="sidebarcolorseven"
                                    />
                                    <label
                                        for="bgcolor7Sidebar"
                                        class="d-block bg-sidebar-color-7 mb-2"
                                    >
                                    </label>
                                </div>
                                <div class="theme-colorselect me-3">
                                    <input
                                        ...
                                        name="sidebar"
                                        id="bgcolor8Sidebar"
                                        value="sidebarcoloreight"
                                    />
                                    <label
                                        for="bgcolor8Sidebar"
                                        class="d-block bg-sidebar-color-8 mb-2"
                                    >
                                    </label>
                                </div>
                                <div class="theme-colorselect me-3">
                                    <input
                                        ...
                                        name="sidebar"
                                        id="bgcolor9Sidebar"
                                        value="sidebarcolornine"
                                    />
                                    <label
                                        for="bgcolor9Sidebar"
                                        class="d-block bg-sidebar-color-9 mb-2"
                                    >
                                    </label>
                                </div>
                                <div class="theme-colorselect me-3">
                                    <input
                                        ...
                                        name="sidebar"
                                        id="bgcolor10Sidebar"
                                        value="sidebarcolorten"
                                    />
                                    <label
                                        for="bgcolor10Sidebar"
                                        class="d-block bg-sidebar-color-10 mb-2"
                                    >
                                    </label>
                                </div>
                                <div class="theme-colorselect me-3">
                                    <input
                                        ...
                                        name="sidebar"
                                        id="bgcolor11Sidebar"
                                        value="sidebarcoloreleven"
                                    />
                                    <label
                                        for="bgcolor11Sidebar"
                                        class="d-block bg-sidebar-color-11 mb-2"
                                    >
                                    </label>
                                </div>
                                <div class="theme-colorselect me-3">
                                    <input
                                        ...
                                        name="sidebar"
                                        id="bgcolor12Sidebar"
                                        value="sidebarcolortwelve"
                                    />
                                    <label
                                        for="bgcolor12Sidebar"
                                        class="d-block bg-sidebar-color-12 mb-2"
                                    >
                                    </label>
                                </div>
                                <div class="theme-colorselect me-3">
                                    <input
                                        ...
                                        name="sidebar"
                                        id="bgcolor13Sidebar"
                                        value="sidebarcolorthirteen"
                                    />
                                    <label
                                        for="bgcolor13Sidebar"
                                        class="d-block bg-sidebar-color-13 mb-2"
                                    >
                                    </label>
                                </div>
                                <div class="theme-colorselect">
                                    <input
                                        ...
                                        name="sidebar"
                                        id="bgcolor14Sidebar"
                                        value="sidebarcolorfourteen"
                                    />
                                    <label
                                        for="bgcolor14Sidebar"
                                        class="d-block bg-sidebar-color-14 mb-2"
                                    >
                                    </label>
                                </div>
                            </div>
                ...
                <div class="accordion-item border px-3">
                    ...
                    >
                        <div class="accordion-body px-0 py3 border-top">
                            <div class="d-flex align-items-center">
                                <div
                                    class="theme-mode flex-fill text-center w-100 me-3"
                                >
                                    <input
                                        type="radio"
                                        name="theme"
                                    ...
                                    <label
                                        for="lightTheme"
                                        class="rounded fw-medium w-100"
                                    >
                                        <span class="d-inline-flex rounded me-2"
                                            ><i
                                                class="ti ti-sun-filled"
                                            ></i></span
                                        >Light
                                    </label>
                                </div>
                                ...
                                >
                                    ...
                                    >
                                        <span class="d-inline-flex rounded me-2"
                                            ><i
                                                class="ti ti-moon-filled"
                                            ></i></span
                                        >Dark
                                    </label>
                                </div>
                                <div
                                    class="theme-mode flex-fill w-100 text-center"
                                >
                                    <input
                                        type="radio"
                                        name="theme"
