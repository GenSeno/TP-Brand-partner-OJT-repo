            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="account-sidebar-menu">
                        ...
                        <li class="active">
                            <Link :href="route('store.brand-partner.cart')"
                                >My Cart</Link
                            >
                        </li>
                ...
                <div class="col-md-9 px-lg-4">
                    <div v-if="cart && cart.items && cart.items.length > 0">
                        <!-- Table Header -->
                        <div
                            class="cart-table-header d-flex text-muted fw-bold pb-3 border-bottom mb-4"
                        >
                            <div
                                style="
                                    flex: 2;
                        ...
                        >
                            ...
                            <div class="item-col d-flex gap-4" style="flex: 2">
                                <div
                                    class="item-image bg-light d-flex align-items-center justify-content-center p-2"
                                    style="
                                        width: 120px;
                                        height: 120px;
                                        flex-shrink: 0;
                                ...
                                <div
                                    class="item-details d-flex flex-column justify-content-center"
                                >
                                    <h5
                                        class="item-name fw-bold mb-1"
                                        style="
                                            font-size: 13px;
                                            font-family:
                            ...
                            <!-- Price Column -->
                            <div
                                class="price-col text-center d-flex flex-column justify-content-center"
                                style="flex: 1"
                            >
                                <div
                                    class="fw-bold"
                                ...
                                <small
                                    class="text-muted text-decoration-line-through mt-1"
                            ...
                            <!-- Quantity Column -->
                            <div
                                class="qty-col d-flex justify-content-center align-items-center"
                                style="flex: 1"
                            >
                                <div
                                    class="qty-box d-flex align-items-center m-auto"
                                >
                                    <button
                            ...
                            <!-- Total Column -->
                            <div
                                class="total-col text-center d-flex justify-content-center align-items-center"
                                style="flex: 1"
                            >
                                <span
                                    class="text-muted"
                                    style="font-size: 12px"
                                    >{{ formatCurrencyPHP(item.total) }}</span
                                >
                            </div>

                            <!-- Delete Column -->
                            <div
                                class="delete-col text-end border-0 bg-transparent flex-shrink-0"
                                style="width: 70px"
                            >
                                <button
                                    class="btn btn-link text-dark fw-bold text-decoration-none p-0"
                                    style="
                                        font-size: 11px;
                    ...
                    <div v-else class="text-center py-5 border bg-light mt-4">
                        <i
                            class="ri-shopping-cart-2-line text-muted mb-3"
                        ...
                        <Link
                            ...
                            class="btn btn-dark px-4 py-2 rounded-0 fw-bold"
                        >
                            START SHOPPING
                        </Link>
                    </div>
