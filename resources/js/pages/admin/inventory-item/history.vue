        ...
        <div class="page-body">
            ...
            <div class="d-flex gap-2 mb-3">
                ...
                <VueDatePicker
                    ...
                    auto-apply
                />
                <button class="btn btn-sm btn-primary" @click="filterMovements">
                    Filter
                </button>
                <button
            ...
            <div class="alert alert-light border mb-3">
                <div class="d-flex justify-content-between mb-2">
                    <span class="fw-bold">{{
                        props.inventoryItem.item_name
                    }}</span>
                    <span class="badge shadow-none badge-xs badge-soft-info">{{
                        props.inventoryItem.type
                    }}</span>
                </div>
                <div class="d-flex">
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="text-nowrap">
                                <span
                                    v-if="movement.adjustment"
                                    class="text-muted"
                                    >Manual Adjustment</span
                                >
                                <span v-else-if="movement.source"
                                    >Job Order #{{ movement.source.id }}</span
                                >
            ...
            >
                <small class="text-muted">
                    Showing {{ props.movements.from }}–{{
                        props.movements.to
                    }}
                    of {{ props.movements.total }} records
                </small>
...
const filteredMovements = computed(() => {
    const filtered = props.movements.data.filter((movement) => {
        ...
        const to = dateRange.value.to
            ? dayjs(dateRange.value.to).endOf('day')
            : null;
