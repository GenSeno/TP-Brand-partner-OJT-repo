                    ...
                    <div class="action-table-data">
                        <div class="edit-delete-action">
                            ...
                            <ModalLink
                                navigate
                                :href="
                                    route('admin.purchase-order.receive', value)
                                "
                            ...
                            <ModalLink
                                navigate
                                :href="
                                    route('admin.purchase-order.edit', value)
                                "
                            ...
                            <dt-delete2
                                ...
                                :url="
                                    route('admin.purchase-order.destroy', value)
                                "
...
onMounted(() => {
    emitter.on('purchase-order:created', () =>
        router.reload({
            preserveState: true,
            preserveScroll: true,
            replace: true,
    ...
    emitter.on('purchase-order:updated', () =>
        router.reload({
            preserveState: true,
            preserveScroll: true,
            replace: true,
...
const supplierMap = computed(() => {
    return Object.fromEntries(props.suppliers.map((s) => [s.id, s.name]));
});
</script>
