    ...
    <div class="card table-list-card">
        ...
        <div class="card-body p-0">
            <dt-table
                ...
                :columns="columns"
                :data="props.staffList.data"
                :total-records="props.staffList.total"
                :start-record="props.staffList.from"
                :end-record="props.staffList.to"
                :links="props.staffList.links"
                :selectable="false"
                @change="submitFilters"
            >
                ...
                <template #action="{ row, value }">
                    <div class="action-table-data">
                        <div class="edit-delete-action">
                            <ModalLink
                                navigate
                                :href="route('admin.staff.edit', value)"
                            ...
                            <dt-delete2
                                ...
                                model-name="staff"
                                :url="route('admin.staff.destroy', value)"
...
const deleteEmitterEvent = ref('staff-deleted');
...
const form = useForm({
    ...
    sort: [],
    per_page: props.staffList.per_page,
});
const selected = ref([]);
