    ...
    <div>
        ...
        >
            <div class="page-header"  >
                <h4 v-if="invoice.status ==InvoiceStatusEnum.PAID">View Payments</h4>
                <h4 v-else>Add Payment</h4>
            </div>

            <form @submit.prevent="submitForm">
                <div class="page-body">
                    <div class="form-area" v-if="invoice.status != InvoiceStatusEnum.PAID">
                    <div class="row g-3">
                        <div class="col-12">
                                ...
                                >
                                            ...
                                            <div class="fw-semibold">
                                                {{
                                                    p.internal_reference
                                                        ? p.internal_reference + (p.reference ? ' / ' + p.reference : '')
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        >
                                            ...
                                            {{
                                                p.sent_at
                                                    ? (isSendingReceipt ? 'Resending...' : 'Resend Payment Receipt')
                                                    : (isSendingReceipt ? 'Sending...' : 'Send Payment Receipt')
                                            }}
                                        </button>
                ...
                <div class="page-footer-buttons mt-3">
                    <div>
                        <button
                            ...
                            @click="close()"
                        >
                            <span v-if="invoice.status == InvoiceStatusEnum.PAID">Close</span>
                            <span v-else>Cancel</span>
                        </button>
                        <submit-btn :loading="form.processing" v-if="invoice.status != InvoiceStatusEnum.PAID"
...
const sendReceipt = (payment) => {
    ...
    router.post(
        route('admin.billing.send-receipt', { billing: props.invoice.id, payment: payment.id} ),
        {},
        {
            onFinish: () => {
