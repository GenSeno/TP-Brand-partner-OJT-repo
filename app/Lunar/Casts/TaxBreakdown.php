...
class TaxBreakdown implements CastsAttributes, SerializesCastableAttributes
{
     ...
     * @return \App\Lunar\ValueObjects\Cart\TaxBreakdown
     */
    public function get($model, $key, $value, $attributes)
    {
        $breakdown = new \App\Lunar\ValueObjects\Cart\TaxBreakdown;
    ...
    {
        if ($value && !is_a($value, \App\Lunar\ValueObjects\Cart\TaxBreakdown::class)) {
            throw new \Exception('Tax breakdown must be instance of App\Lunar\ValueObjects\Cart\TaxBreakdown');
        }
